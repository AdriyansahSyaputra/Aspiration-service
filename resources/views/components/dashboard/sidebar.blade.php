<aside class="bg-slate-800 w-64 min-h-screen fixed flex flex-col">
    ...
    <div class="flex-1 overflow-y-auto py-8">
        <div class="px-4">
            ...
            <nav class="space-y-2">
                <!-- Dashboard -->
                <a href="/dashboard"
                    class="group flex items-center px-4 py-3 text-gray-400 hover:text-white rounded-lg hover:bg-white/10 transition-all duration-200">
                    <i class="fa-solid fa-gauge-high w-5 h-5"></i>
                    <span class="ml-3">Dashboard</span>
                    <i
                        class="fa-solid fa-chevron-right ml-auto opacity-0 group-hover:opacity-100 transition-opacity"></i>
                </a>
    ...
    <div class="border-t border-slate-700 p-4">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button
                class="group flex items-center w-full px-4 py-3 text-gray-400 hover:text-white rounded-lg hover:bg-white/10 transition-all duration-200">
